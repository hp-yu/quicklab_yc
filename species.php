...
<?php
  js_selectall();
?>
<form action="species.php" method="get" name="search" target="_self" id="form1">
  <table width="100%" class="search">
    <tr><td align="center">
      <h2>Species&nbsp;&nbsp;<a href='species_operate.php?type=add'><img src='./assets/image/general/add.gif' alt='Add new' title='Add new' border='0'/></a></h2></td>
    </tr>
<?php
$fields="CONCAT(`name`,`latin`)";
search_keywords('species',$fields);
...
<?php
 ...
 if ($results&&$results->num_rows>0)
 {
	...
	echo "Common name</td><td class='results_header'>";
	echo "Scientific name</td><td class='results_header'>";
	echo "Operate</td></tr>";
    while ($matches = $results->fetch_array())
    {
    echo "<tr><td class='results'>".$matches['id']."</td><td class='results'>";
    echo $matches['name']."</td><td class='results'>";
	  echo "<i>".$matches['latin']."</i></td><td class='results'>";
      echo '<a href="species_operate.php?type=edit&id='.$matches['id'].'"><img src="./assets/image/general/edit-s.gif" alt="Edit" title="Edit" border="0"/></a></td></tr>';
    }
    echo '</table></form>';
  }
?>
