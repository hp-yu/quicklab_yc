...
?>
<?php
do_html_header('Proteins operate-Quicklab');
do_header();
do_leftnav();
standard_form();
do_rightbar();
...
$(document).ready(function() {
	...
	echo "<table width='100%' class='operate'>
          ...
          <h2>Proteins operate</h2></div></td></tr>";
	process_request();
}
function add_form()
{
...
function edit_form()
{
  ...
  <tr><td colspan='2'><h3>Edit:</h3></td>
      ...
      <tr>
        ...
        <td><textarea name='raw_seq' class="sequence" cols="80" rows="6" onchange="tidyup('raw_seq');cal_seq_len()"><?php
        $db_conn = db_connect();
...
function detail()
{
  ...
  <tr><td colspan='2'><h3>Detail:
      ...
      <tr>
        ...
        $project= get_name_from_id('projects',$primer['project']);
      ...
      <tr>
        ...
        ?>'><img src='./assets/image/general/back.gif' alt='Back' border='0'/></a></td></tr>
    </table>
  <?php
}
